...
/**
 * Spray programme summary card with View / Edit / Delete actions.
 * Used for the responsive card layout (primary on tablet/mobile).
 *
 * @param {object} record - Normalised spray programme (incl. vineyardName/blockName).
 * @param {function} onView
 * @param {function} onEdit
 * @param {function} onDelete
 */
function SprayProgrammeCard({ record, onView, onEdit, onDelete }) {
  return (
...
export default SprayProgrammeCard;
