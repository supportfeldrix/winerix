        ...
        <TableBody>
          {records.map((r) => (
            <TableRow key={r.id} hover>
              ...
              <TableCell align="right">{r.yieldTons != null ? `${formatNumber(r.yieldTons)} t` : '—'}</TableCell>
              <TableCell>
                {r.status ? <Chip label={r.status} size="small" color={activityStatusColor(r.status)} sx={{ textTransform: 'capitalize' }} /> : '—'}
              </TableCell>
